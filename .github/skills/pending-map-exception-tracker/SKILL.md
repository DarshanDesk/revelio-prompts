---
name: pending-map-exception-tracker
description: "Tracks PENDING_MAP orphans and enforces the 5.0% alert threshold. Activates when computing orphan ratios by (VENDOR_ID, REPORT_DATE), triage grain analysis, or restatement lineage. Does not cover DDL generation or SCD2 logic."
metadata:
  version: "1.0.0"
