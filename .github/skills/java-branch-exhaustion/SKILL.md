---
name: java-branch-exhaustion
description: "Generates branch-exhaustion tests with JUnit 5. Activates when writing null, edge, and boundary tests targeting 90% branch coverage with Mockito isolation. Does not cover Spring integration tests."
---
