...
description: "Identifies logical contradictions in prompt configurations. Activates when performing cross-agent consistency checks or instruction validation."
---
