---
name: python-duckdb-optimizer
description: "Optimizes DuckDB queries within Python applications. Activates when tuning DuckDB query performance, implementing connection pooling, or profiling query execution."
metadata:
  version: "1.0.0"
---
