---
name: audit-exception-reporter
description: "Implements the PENDING_MAP orphan exception view, 5.0% threshold gate, and restatement lineage tracking. Activates when building vw_pending_map_exceptions, alert SQL, or restatement audit trails. Does not cover SCD2 integrity checks."
metadata:
  version: "1.0.0"
