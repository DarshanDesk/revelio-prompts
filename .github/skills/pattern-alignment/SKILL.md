...
description: "Validates alignment between agent output patterns and gold standard conventions. Activates when performing XML structure validation or checking agent output conformance."
---
