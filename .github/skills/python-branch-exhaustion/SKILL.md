---
name: python-branch-exhaustion
description: "Generates branch-exhaustion tests with pytest. Activates when writing null, edge, and boundary tests targeting 90% branch coverage with fixture-based isolation."
---
