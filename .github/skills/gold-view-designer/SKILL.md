---
name: gold-view-designer
description: "Implements gold view patterns using IS_CURRENT = TRUE filters. Activates when building vw_financial_latest_gold, ROW_NUMBER() priority filtering views, or PENDING_MAP exclusion views. Does not cover DDL generation."
metadata:
  version: "1.0.0"
