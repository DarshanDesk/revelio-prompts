---
name: echo-validator
description: "Validates prompt context integrity via pipeline echo tags. Activates when checking echo tag presence, confirming pipeline step completion, or validating ReACT cycle state."
---
