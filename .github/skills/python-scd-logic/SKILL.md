---
name: python-scd-logic
description: "Generates SCD logic for Python dbt models. Activates when implementing Python-layer SCD2 helper functions or EFF_FROM/EFF_TO calculations."
metadata:
  version: "1.1.0"
---
