---
name: python-fastapi-slice
description: "Implements FastAPI slice test architecture for isolated endpoint testing. Activates when writing FastAPI endpoint tests, TestClient patterns, or dependency injection overrides."
---
