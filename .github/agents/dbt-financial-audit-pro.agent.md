---
description: "Step 4 of 4: Generates data quality tests, enforces PENDING_MAP alerts at the 5.0% gate, and validates SCD2 integrity for the financial risk pipeline."
---
...
<agent>
    ...
    <capabilities>
        <skill id="audit_test_generator" skill_file=".github/skills/audit-test-generator/SKILL.md">
        ...
        <skill id="scd2_integrity_validator" skill_file=".github/skills/scd2-integrity-validator/SKILL.md">
        ...
        <skill id="audit_exception_reporter" skill_file=".github/skills/audit-exception-reporter/SKILL.md">
