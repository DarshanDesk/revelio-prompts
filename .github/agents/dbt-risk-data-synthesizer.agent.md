---
description: "Step 2 of 4: Generates 6 CSV seed files with Day 0/Day N structure and PENDING_MAP injection for the financial risk pipeline."
---
...
<agent>
    ...
    <capabilities>
        <skill id="synthetic_data_factory" skill_file=".github/skills/synthetic-data-factory/SKILL.md">
