---
description: "Orchestrates stage-gate sequencing across all 4 dbt agents. Activates when enforcing pipeline step order or preventing out-of-sequence skill invocation."
---
