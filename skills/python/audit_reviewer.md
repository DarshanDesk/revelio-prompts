<skill_definition name="audit_reviewer">
  <metadata>
    ...
    <capability>Static Analysis & Compliance Audit of dbt Models</capability>
    <scope>@workspace (Models, Snapshots, and Seeds)</scope>
  </metadata>

  <description>
    This skill performs a structural audit of the dbt project. It ensures that 
    the financial integrity rules—specifically the 'D' flag filtering and 
    the Snapshot-first dependency chain—are strictly followed.
  </description>
